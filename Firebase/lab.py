...
def agregar_muestra(nombre, descripcion,estado):  # CREATE
    try:
        ...
        datos_muestra = {
            ...
            'estado': estado  # Añadimos un estado por defecto
        }
...
def menu():
    while True:
        ...
        if opcion == "1":
            ...
            estado= input("ingresa el estado de la muestra(dañado,fresco,alterado...) : ")
            agregar_muestra(nombre, descripcion,estado)
